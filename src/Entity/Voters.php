...
/**
 * @ORM\Entity(repositoryClass="App\Repository\VotersRepository")
 */
class Voters
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Activites", inversedBy="voters")
     */
    private $id_activite;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Personnes", inversedBy="voters")
     */
    private $id_personne;
